...
test.describe('Public API Endpoints', () => {
  ...
  test('GET {{ cookiecutter.backend_api_prefix }}/health/ready should return ready status', async ({ request }) => {
    const response = await request.get('{{ cookiecutter.backend_api_prefix }}/ready');
...
test.describe('Protected API Endpoints', () => {
  ...
  test('GET {{ cookiecutter.backend_api_prefix }}/test/protected should succeed with admin token', async ({ request }) => {
  ...
  test('GET {{ cookiecutter.backend_api_prefix }}/test/protected should succeed with user token', async ({ request }) => {

#!/usr/bin/env bash
# {{ cookiecutter.project_name }} - OpenAPI TypeScript Client Generator
#
...
HEALTH_ENDPOINT="{{ cookiecutter.backend_api_prefix }}/health"
...
ENVIRONMENT VARIABLES:
    BACKEND_URL   Override backend URL (default: http://localhost:{{ cookiecutter.backend_port }})
...
main() {
    ...
    echo ""
    echo -e "${GREEN}=== {{ cookiecutter.project_name }} - OpenAPI TypeScript Client Generator ===${NC}"
    echo ""

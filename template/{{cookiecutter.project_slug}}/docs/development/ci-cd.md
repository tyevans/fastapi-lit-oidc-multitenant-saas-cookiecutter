...
This document describes the Continuous Integration and Continuous Deployment setup for {{ cookiecutter.project_name }}.
...
**Images pushed to:**
- `ghcr.io/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}-backend`
- `ghcr.io/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}-frontend`
...
2. **Add your repository**
   ...
   - Select `{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}`

...
pgbouncer:
  ...
  environment:
    DATABASE_URL: postgres://{{ cookiecutter.postgres_user }}:${POSTGRES_PASSWORD}@postgres:5432/{{ cookiecutter.project_slug }}
...
# compose.yml
keycloak:
  image: quay.io/keycloak/keycloak:{{ cookiecutter.keycloak_version }}
  environment:
    KC_CACHE: ispn

...
| Dashboard | URL |
|-----------|-----|
| Infrastructure | http://localhost:{{ cookiecutter.grafana_port }}/d/infrastructure |
| Backend | http://localhost:{{ cookiecutter.grafana_port }}/d/backend |
| PostgreSQL | http://localhost:{{ cookiecutter.grafana_port }}/d/postgres |
| Redis | http://localhost:{{ cookiecutter.grafana_port }}/d/redis |
| Keycloak | http://localhost:{{ cookiecutter.grafana_port }}/d/keycloak |
{% else %}
Observability stack not included. Configure external monitoring as needed.
{% endif %}

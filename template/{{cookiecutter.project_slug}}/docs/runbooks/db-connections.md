...
| Item | Value |
|------|-------|
| **Dashboard** | http://localhost:{{ cookiecutter.grafana_port }}/d/postgres/postgres-overview |
...
curl -s http://localhost:{{ cookiecutter.backend_port }}/metrics | grep sqlalchemy_pool
...
- [Grafana PostgreSQL Dashboard](http://localhost:{{ cookiecutter.grafana_port }}/d/postgres)

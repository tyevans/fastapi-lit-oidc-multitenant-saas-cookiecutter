...
def oauth_client():
    ...
    return OAuthClient(
        ...
        issuer_url="http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}",
...
def mock_oidc_discovery():
    ...
    return {
        ...
        "userinfo_endpoint": "http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}/protocol/openid-connect/userinfo",
        "end_session_endpoint": "http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}/protocol/openid-connect/logout",
    }
...
class TestOIDCDiscovery:
    ...
    async def test_discover_endpoints_success(self, oauth_client, mock_oidc_discovery):
        ...
        with patch.object(oauth_client._http_client, "get") as mock_get:
            ...
            assert config.issuer == "http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}"
...
class TestAuthorizationURL:
    ...
    async def test_authorization_url_generation(self, oauth_client, mock_oidc_discovery):
        ...
        with patch.object(oauth_client._http_client, "get") as mock_get:
            ...
            assert url.startswith("http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}/protocol/openid-connect/auth")

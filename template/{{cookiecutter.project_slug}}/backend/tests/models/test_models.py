...
class TestOAuthProviderModel:
    ...
    def test_oauth_provider_creation(self):
        ...
        assert provider.issuer == "http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}"
        assert provider.client_id == "{{ cookiecutter.keycloak_backend_client_id }}"
        assert provider.client_secret == "secret123"
        assert provider.jwks_uri == "http://keycloak:{{ cookiecutter.keycloak_port }}/realms/{{ cookiecutter.keycloak_realm_name }}/protocol/openid-connect/certs"

...
if "DATABASE_URL" not in os.environ:
    # Use {{ cookiecutter.postgres_migration_user }} for tests since tests need full permissions
    os.environ["DATABASE_URL"] = "postgresql+asyncpg://{{ cookiecutter.postgres_migration_user }}:{{ cookiecutter.postgres_migration_password }}@postgres:5432/{{ cookiecutter.postgres_db }}"
...
if "OAUTH_AUDIENCE" not in os.environ:
    # Keycloak default client uses 'account' as audience, not '{{ cookiecutter.keycloak_backend_client_id }}'
...
KEYCLOAK_REALM = "{{ cookiecutter.keycloak_realm_name }}"
KEYCLOAK_CLIENT_ID = "{{ cookiecutter.keycloak_backend_client_id }}"
KEYCLOAK_CLIENT_SECRET = "{{ cookiecutter.keycloak_backend_client_id }}-secret"
...
async def get_keycloak_token(
    ...
    Args:
        ...
        client_id: OAuth client ID (default: {{ cookiecutter.keycloak_backend_client_id }})

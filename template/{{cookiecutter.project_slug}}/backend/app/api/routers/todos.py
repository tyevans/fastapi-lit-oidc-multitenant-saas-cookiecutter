...
async def get_todos(user: CurrentUser) -> list[dict]:
    """
...
async def create_todo(todo: TodoCreate, user: CurrentUser) -> dict:
    """
    Create a new todo.
...
async def get_todo(todo_id: str, user: CurrentUser) -> dict:
    """
...
async def update_todo(todo_id: str, todo: TodoUpdate, user: CurrentUser) -> dict:
    """
...
async def delete_todo(todo_id: str, user: CurrentUser) -> None:
    """
